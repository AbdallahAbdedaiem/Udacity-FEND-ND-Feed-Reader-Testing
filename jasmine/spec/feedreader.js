    ...
    */
    ...
    describe("New Feed Selection", function() {
        ...
        */
        ...
        beforeEach(function(done) {
            /*
            in this test we need to run two async functions, we called the second method in callback function
            the fist one. Then we called done method in the callback function of the second one to run the test after completing these two async functions.
            */
            loadFeed(0,function(){
                feed1 = $(".feed").html();
                loadFeed(1,function(){
